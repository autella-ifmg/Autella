...
<body>
    <div id = "oi" onclick="teste()">AQUI O</div>
    <div id = "AL" onclick="teste()"></div>
    
  <script>
           document.getElementById("oi").innerHTML = document.getElementById("TESTE2").outerHTML;
   
      var globalList = [];
      function globalSend(id){
          document.getElementById("global").innerHTML += "";
          globalList[globalList.length] = id;
      }
  </script>

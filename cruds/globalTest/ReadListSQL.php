            ...
            for ($i = 0; $i < count($array); $i++) {
                ...
                <td>
                    <div class="custom-control custom-switch">
                            <input id="customSwitch' . $id_test . '" type="checkbox" class="custom-control-input" value="global" onchange="setStatusOfListAnswers(' . $id_test . ', \'' . $nameTest . '\')"' . $status_list_answers . '>

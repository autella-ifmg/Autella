    ...
    if (!empty($array)) {
        if (count($array) > 0) {
            for ($i = 0; $i < count($array); $i++) {
                ...
                if ($id_role == 1) {
                    echo '
                        <div class="p-2 w-auto border border-dark border-left-0"> <img src="../../../libraries/bootstrap/bootstrap-icons-1.0.0/pencil-square.svg" alt="Editar" height="25" onclick="chooseAction(0, ' . ($questionNumber) . ')" data-toggle="modal" data-target="#editModal"  data-toggle="tooltip" data-placement="bottom" title="Editar questão"/></div>
                        <div class="p-2 w-auto border border-dark border-left-0"> <img src="../../../libraries/bootstrap/bootstrap-icons-1.0.0/archive-fill.svg" alt="Arquivar" height="25" onclick="chooseAction(1, ' . ($questionNumber) . ')" data-toggle="modal" data-target="#archiveModal"  data-toggle="tooltip" data-placement="bottom" title="Arquivar questão"/></div>
                        <div class="p-2 w-auto border border-dark border-left-0"> <img src="../../../libraries/bootstrap/bootstrap-icons-1.0.0/trash-fill.svg" alt="Deletar" height="25" onclick="chooseAction(2, ' . ($questionNumber) . ')" data-toggle="modal" data-target="#deleteModal"  data-toggle="tooltip" data-placement="bottom" title="Deletar questão"/></div>';

    ...
    <section class="d-flex justify-content-center mt-4">
        <div class="d-flex flex-column">
            <form id="questionForm" action="updateSQL.php" method="post">
                ...
                <span id="enunciate_popover" class="d-flex flex-row mb-3" data-toggle="popover" data-placement="top" data-html="true" data-content='<img class="p-1 w-auto h-auto" src="../../images/question/ckeditor-warning-icon/warning.png" alt="Atenção!"> Este campo não pode ficar vazio.'>
                    <div id="editor0" style="min-width: 72rem; max-width: 72rem; min-height: 20rem; max-height: 20rem; border: 1px solid gray;" onclick="disablePopover('#enunciate_popover')"><?php echo $questionForUpdate["enunciate"]; ?></div>
                </span>
